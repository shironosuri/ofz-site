    ...
    content: [
      {
        ...
        heading: 'Dive into the marvels of modern innovation, where the only constant is change. A journey where pixels and data converge to craft the future.',
        body: {
          root: {
            type: 'root',
            children: [
      ...
      {
        blockType: 'richTextSection',
        heading: 'The Rise of AI and Machine Learning',
        body: {
          root: {
            type: 'root',
            children: [
      ...
      {
        blockType: 'richTextSection',
        heading: 'IoT: Connecting the World Around Us',
        body: {
          root: {
            type: 'root',
            children: [
      ...
      {
        blockType: 'richTextSection',
        heading: 'Technology Stack Comparison',
        body: {
          root: {
            type: 'root',
            children: [
                ...
                children: [
                  {
                    ...
                    mode: 'normal',
                    style: '',
                    text: 'Here is a comparison of different technologies using our stack grid component:',
                    version: 1,
                  },
                ],
                direction: 'ltr',
              ...
              },
              {
                type: 'block',
                fields: {
                  blockName: 'Technology Comparison',
                  ...
                  items: [
                    ...
                    },
                    {
                      ...
                      description: 'Decentralized and secure transactions',
                    },
                  ],
                },
                format: '',
