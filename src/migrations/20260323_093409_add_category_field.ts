...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_posts_tags" AS ENUM('javascript', 'typescript', 'css', 'payload', 'nextjs', 'react');
  CREATE TYPE "public"."enum_posts_category" AS ENUM('craft', 'theory', 'process');
  CREATE TYPE "public"."enum_posts_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__posts_v_version_tags" AS ENUM('javascript', 'typescript', 'css', 'payload', 'nextjs', 'react');
  CREATE TYPE "public"."enum__posts_v_version_category" AS ENUM('craft', 'theory', 'process');
